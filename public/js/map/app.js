...
var _require = __webpack_require__(/*! ./map */ "./resources/assets/js/map.js"),
    search = _require.search,
    loadBusiness = _require.loadBusiness;

var _require2 = __webpack_require__(/*! ./analytics */ "./resources/assets/js/analytics.js"),
    trackOutboundLink = _require2.trackOutboundLink;
...
/***/ "./resources/assets/js/components/business.js":
/*!****************************************************!*\
  !*** ./resources/assets/js/components/business.js ***!
  \****************************************************/
/*! no static exports found */
...
function formatBusinessHeader(business) {
  var compact = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var $heading = $('<div class="business__heading"></div>');
  $heading.append("<h2>".concat(business.name, "</h2>"));

  if (business.averageScore && !compact) {
    var stars = business.averageScore * 20;
    $heading.append("\n            <div class=\"hidden business__average-score\">\n                <span class=\"score\" title=\"".concat(business.averageScore, " out of 5 stars\">\n                <div class=\"score-wrap\">\n                    <span class=\"stars-active\" style=\"width:").concat(stars, "%\">\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                    </span>\n                    <span class=\"stars-inactive\">\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                        <i class=\"fa fa-star\" aria-hidden=\"true\"></i>\n                    </span>\n                </div>\n                </span>\n            </div>\n        "));
  }

  if (business.positiveReviewPc) {
    reviewText = "\n            <div class=\"business__positive-review-percentage\">\n                <h2>".concat(business.positiveReviewPc, "%</h2>\n                <span>positive reviews</span>");

    if (!compact && business.reviewSourceUrl) {
      var reviewSourceUrl = business.reviewSourceUrl.indexOf('http') === 0 ? business.reviewSourceUrl : 'http://' + business.reviewSourceUrl;
  ...
  if (!compact) {
    $heading.append("<p class=\"business__description\">".concat(business.description, "</p>"));
  }
...
function formatBusinessDetails(business) {
  var compact = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  var $details = $('<div class="business__details"></div>');

  if (!compact) {
    var $categories = $('<ul class="business__categories"></ul>');
    business.categories.forEach(function (category) {
      $categories.append("<li>".concat(category, "</li>"));
    });
    $details.append($categories);
  }

  var $columns = $('<div class="row"></div>');
  var $leftColumn = $("<div class=\"".concat(compact ? 'col-md-12' : 'col-md-12 col-sm-6', "\"></div>"));
  var $rightColumn = $("<div class=\"".concat(compact ? 'col-md-12 business__extra-details' : 'col-md-12 col-sm-6', "\"></div>"));

  if (business.website) {
    var website = business.website.indexOf('http') === 0 ? business.website : 'http://' + business.website;
    $leftColumn.append("\n            <p class=\"business-detail\">\n                <span class=\"fa fa-globe\"></span>\n                <a target=\"_blank\" rel=\"noopener\" href=\"".concat(website, "\" onclick=\"trackOutboundLink('").concat(website, "');\">\n                    ").concat(business.website, "\n                </a>\n            </p>\n        "));
  }

  if (business.email) {
    var href = "mailto:".concat(business.email);
    $leftColumn.append("\n            <p class=\"business-detail\">\n                <span class=\"fa fa-envelope\"></span>\n                <a href=\"".concat(href, "\" rel=\"noopener\" onclick=\"trackOutboundLink('").concat(href, "';\">\n                    ").concat(business.email, "\n                </a>\n            </p>\n        "));
  }

  if (business.landline || business.mobile) {
    var phoneNumber = business.landline || business.mobile;

    var _href = "tel:".concat(phoneNumber);

    $leftColumn.append("\n            <p class=\"business-detail\">\n                <span class=\"fa fa-phone\"></span>\n                <a href=\"".concat(_href, "\" rel=\"noopener\" onclick=\"trackOutboundLink('").concat(_href, "');\">\n                    ").concat(phoneNumber, "\n                </a>\n            </p>\n        "));
  }

  var completeAddress = [business.address, business.city, business.postcode].filter(Boolean).join(', ');
  $leftColumn.append("\n        <p class=\"business-detail\">\n            <span class=\"fa fa-map-marker\"></span>\n            <span>".concat(completeAddress, "</span>\n        </p>\n    "));
  $columns.append($leftColumn);

  if (business.warrantyOffered) {
    $rightColumn.append("\n            <p class=\"business-detail business-detail--scrollable\">\n                <span class=\"fa fa-calendar-check\"></span>\n                <span>Warranty: ".concat(business.warranty || 'Provided', "</span>\n            </p>\n        "));
  }

  if (business.qualifications) {
    $rightColumn.append("\n            <p class=\"business-detail\">\n                <span class=\"fa fa-mortar-board\"></span>\n                <span>".concat(business.qualifications, "</span>\n            </p>\n        "));
  }

  if (business.updatedAt) {
    // Parse of full date fails on Safari; we only want the date anyway, so trim it.
    var updatedAt = new Date(business.updatedAt.date.substring(0, 10)).toLocaleDateString('en-GB');
    $rightColumn.append("\n        <p class=\"business-detail\">\n            <span class=\"fa fa-calendar\"></span>\n            <span>Last updated: ".concat(updatedAt, "</span>\n        </p>\n    "));
  }
  ...
  if (business.communityEndorsement) {
    $details.append("\n            <div class=\"row business__extra-details\">\n                <div class=\"col-12\">\n                    <p class=\"business-detail\">\n                        <span class=\"fa fa-comments\"></span>\n                        <span>Restart Community Endorsement:<br>".concat(business.communityEndorsement, "</span>\n                    </p>\n                </div>\n            </div>\n        "));
  }
...
var renderBusiness = __webpack_require__(/*! ./components/business */ "./resources/assets/js/components/business.js");

var _require = __webpack_require__(/*! ./util */ "./resources/assets/js/util.js"),
    hideElement = _require.hideElement,
    showElement = _require.showElement,
    enableElement = _require.enableElement,
    disableElement = _require.disableElement;
...
var markers = [];
var $businessPopup;
var $businessListContainer;
var $searchButton;
var $closeButton;
var $moreInfoPopup;
var $moreInfoLink;
var $moreInfoCloseButton;
...
function search() {
  ...
  $(document).ready(function () {
    window.location.hash = ''; // when embedded in iframe
    ...
    setupElements(); // add form handler
    ...
    setupForm(); // close button should hide the displayed business

    $closeButton.click(hideRepairer); // back and forward browser button support

    window.onpopstate = function () {
      if (window.location.hash && window.location.hash.length > 1) {
        var uid = parseInt(window.location.hash.substring(1), 10);
        var business = findBusiness(uid);
...
function loadBusiness(businessId) {
  ...
  $(document).ready(function () {
    ...
    onSearch(createQuery(), function () {
      var business = findBusiness(businessId);
      var marker = findMarker(businessId);
...
function onSearch(query, cb) {
  if (query.location || query.category) {
    ...
    var zoom = query.radius > 10 ? 10 : 13;
...
function addRepairer(business) {
  ...
  markers.push(marker);
  var $business = $("\n        <li role=\"button\" class=\"business-list__item\" id=\"business-".concat(business.uid, "\">\n            ").concat(renderBusiness(business, true), "\n        </li>\n    "));
...
function scrollToRepairer(business) {
  var $sidebar = $('.sidebar');
  var $business = $sidebar.find('#business-' + business.uid);
  $sidebar.animate({
    scrollTop: $business.offset().top - $sidebar.offset().top + $sidebar.scrollTop() - 100
  });
}
...
function showRepairer(business, marker) {
  ...
  var latOffset = isMobile ? 0 : mapHeightPercent / dpPerDegree;
  marker.setIcon('https://maps.google.com/mapfiles/ms/icons/red-dot.png');
  map.setCenter({
    lat: business.geolocation.latitude + latOffset,
    lng: business.geolocation.longitude
  });
...
function trackSearch(category) {
  window.ga('send', 'event', 'search', 'submit', category || 'All Categories', {
    'transport': 'beacon'
  });
}

function trackRepairerSelection(business) {
  var value = [business.name, business.address, business.postcode].join(', ');
  window.ga('send', 'event', 'map', 'select', value, {
    'transport': 'beacon'
  });
}
...
__webpack_require__(/*! /home/restart/Code/repairdirectory/resources/assets/js/app.js */"./resources/assets/js/app.js");
module.exports = __webpack_require__(/*! /home/restart/Code/repairdirectory/resources/assets/sass/app.scss */"./resources/assets/sass/app.scss");
