...
var renderBusiness = __webpack_require__(5);
...
var businesses = [];
var markers = [];
var $businessPopup = void 0;
var $businessListContainer = void 0;
...
function showRepairer(business, marker) {
  ...
  var mapOffset = isMobile ? 0 : 0.025;
...
function formatBusinessDetails(business) {
    ...
    var $leftColumn = $('<div class="' + (compact ? 'col-md-12' : 'col-md-12 col-sm-6') + '"></div>');
    var $rightColumn = $('<div class="' + (compact ? 'col-md-12 business__extra-details' : 'col-md-12 col-sm-6') + '"></div>');
    ...
    if (business.email) {
        var href = 'mailto:' + business.email;
    ...
    if (business.landline || business.mobile) {
        ...
        $leftColumn.append('\n            <p class="business-detail">\n                <span class="fa fa-phone"></span>\n                <a href="' + _href + '" onclick="trackOutboundLink(\'' + _href + '\');">\n                    ' + phoneNumber + '\n                </a>\n            </p>\n        ');
    }
...
module.exports = { trackOutboundLink: trackOutboundLink };
