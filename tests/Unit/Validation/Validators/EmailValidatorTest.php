...
use TheRestartProject\RepairDirectory\Validation\Validators\EmailValidator;
...
class EmailValidatorTest extends ValidationTestCase
{
    ...
    public function it_throws_a_validation_exception_when_email_invalid()
    {
        try {
            ...
            self::assertEquals('Email invalid: must be between 6 and 100 characters long', $e->getMessage());
        }
